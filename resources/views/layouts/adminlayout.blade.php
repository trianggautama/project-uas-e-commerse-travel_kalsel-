...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="../../index2.html" class="logo">
      ...
      <span class="logo-lg"><b>Travel </b>Kalsel</span>
    </a>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          <a href="#">
            <i class="fa fa-dashboard"></i> <span>Data Travel</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="{{ url('/admin/destinasi') }}"><i class="fa fa-circle-o"></i> Destinasi</a></li>
            <li><a href="{{ url('/admin/jadwal') }}"><i class="fa fa-circle-o"></i> Jadwal</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
